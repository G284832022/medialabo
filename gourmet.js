...
for(let l = 0;l<2;l++){
  ...
  console.log("予算:"+data.results.shop[l].budget.name);
  console.log("キャッチコピー:"+data.results.shop[l].catch);
  console.log("サジャンル:"+data.results.shop[l].genre.name);
  console.log("営業時間:"+data.results.shop[l].open);
  console.log("最寄駅:"+data.results.shop[l].station_name);
